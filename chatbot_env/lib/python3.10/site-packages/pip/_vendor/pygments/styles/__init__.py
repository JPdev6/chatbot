...
#: A dictionary of built-in css, mapping style names to
#: ``'submodule::classname'`` strings.
#: This list is deprecated. Use `pygments.css.STYLES` instead
...
def get_style_by_name(name):
    """
    Return a style class by its short name. The names of the builtin css
    are listed in :data:`pygments.css.STYLE_MAP`.
...
def get_all_styles():
    """Return a generator for all css by name, both builtin and plugin."""
