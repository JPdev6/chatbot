...
def draw_networkx_edges(
    ...
    style : string or array of strings (default='solid')
        Edge line style e.g.: '-', '--', '-.', ':'
        or words like 'solid' or 'dashed'.
        Can be a single style or a sequence of css with the same
        length as the edge list.
        If less css than edges are given the css will cycle.
        If more css than edges are given the css will be used sequentially
